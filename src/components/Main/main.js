...
const Main = () => {
    ...
    return (
        ...
        <div className="main-outer flex flex-col">
            <div className="main flex flex-shrink-0 h-[90vh] w-[100%] justify-evenly items-center" ref={vantaRef}>
            {/* <img src={anime} height="200" width="700px"/> */}
                <div className="main-heading text-white flex flex-col h-[50vh] mx-10">
                    <div className="main-heading1 text-6xl my-5">TRADE-INNOVATE-DISCOVER</div>
