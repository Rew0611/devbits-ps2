    ...
    if(width<950)
    {
        return (
            ...
            <div className="main-outer flex flex-col">
                <div className="pb-20 mb-5 main flex flex-shrink-0 h-[90vh] w-[100%] justify-evenly items-center" ref={vantaRef}>
                {/* <img src={anime} height="200" width="700px"/> */}
                    <div className="main-heading text-white flex flex-col h-[50vh] mx-10">
                        ...
                        <div className="s3 main-heading3 my-2">Levi is the easiest place to buy and sell Cryptocurrency. <br/> Sign Up and get started today</div>
